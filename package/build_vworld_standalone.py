...
SOURCE_FILES = ("vworld_broker_app.py", "vworld_broker.py", "auto_send.py")
ENTRY = "vworld_broker_app.py"
EXE_NAME = "중개업소_신규개업수집기"
OBF_DIR = os.path.join(PROJECT_DIR, "dist_obf_vworld")
WORK_DIR = os.path.join(PROJECT_DIR, "build_vworld")


def main() -> int:
    ap = argparse.ArgumentParser()
    default_out = os.path.join(os.path.expanduser("~"), "Desktop", f"중개업소_신규개업수집기_{datetime.now():%y%m%d}")
