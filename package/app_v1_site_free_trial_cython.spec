...
"""
Cython .pyd + PyInstaller (v1 site 무료체험)
...
STAGE = os.path.join(SPEC_DIR, "dist_cython_build_v1_site_free_trial")
...
a = Analysis(
    [os.path.join(STAGE, 'launcher_cython_v1_site_free_trial.py')],
