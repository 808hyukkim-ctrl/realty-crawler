...
"""
Cython .pyd + PyInstaller

의존성 번들: launcher → cython_bundle_deps.py 가 import 그래프를 제공
           (spec에 collect_all / 패키지 목록 나열 불필요)
...
STAGE = os.path.join(SPEC_DIR, "dist_cython_build")
...
a = Analysis(
    [os.path.join(STAGE, 'launcher_cython_v1.py')],
